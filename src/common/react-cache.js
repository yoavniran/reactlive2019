...
//COPIED FROM REACT-CACHE 2.0.0-alpha1
// because it doesnt work with the latest version of React without small modification (dispatcher)
...
if (process.env.NODE_ENV !== "production") {
	(function() {
		...
		var currentDispatcher = React.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentDispatcher; //YN: modified

		function readContext(Context, observedBits) {
			var dispatcher = currentDispatcher.current; //YN: modified
			if (dispatcher === null) {
